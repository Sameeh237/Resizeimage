...
qualitytInput = document.querySelector(".quality input"),
...
const loadFile = (e)=>{
    ...
    if(!file) return; // return if user hasn't selected any files
...
widthInput.addEventListener("keyup", ()=>{
    //getting height according to chechbox status
...
const resizeAndDownload = ()=>{
    ...
    const imgQuality = qualitytInput.checked ? 0.7 : 1.0;
    ...
    a.download = new Date().getTime(); // passing cirrent time as download value
